...
\author{Giorgia Fugallo}%\email{giorgia.fugallo@univ-nantes.fr}
    \affiliation{{\color{red}CNRS, UMR 6607, Laboratorie de Thermique et Energie
...
{\color{red} The advantage of having the spectral representation of the
...
\caption{{\color{red} First four Brillouin zones with the two selected paths
...
close to twice that value. The ALDA and RPA calculations yield spectra
...
for all calculated values of $q$. {\color{red} This stretching improves the
...
peak values.
{\color{red}
All of our calcations follow the well-documented quadratic dispersion relation 
...
{\color{red} The red dashed line is a quadratic fit for the theoretical points.}
}
...
\caption{%
{\color{red}
Color map representations of the calculated EEL spectra vs. transfered momentum
