...
by us in Ref. \onlinecite{andersonPRB15}. It includes three features not
...
section. We mention that the formulas presented in Ref. \onlinecite{mejiaPRB02},
where the three layer model was introduced for the first time, have some minor
mistakes that have been corrected in Ref. \onlinecite{anderson2016}. These
...
%% Fig. \ref{fig:epsilon} illustrates these components of
%% $\boldsymbol{\epsilon}_\ell(\omega)$ and compares them with the average,
%% $\varepsilon_\ell(\omega)$.

%% \begin{figure}[t]
%% \centering
%% \includegraphics[width=0.48\textwidth]{fig2}
%% \caption{(Color online) Comparison between the absolute values of the
%% different components of $|\boldsymbol{\epsilon}_\ell(\omega)|$ with
%% $|\varepsilon_{\ell}(\omega)|$. $\epsilon^{xx}_{\ell}(\omega)$ and
%% $\epsilon^{yy}_{\ell}(\omega)$ are identical for this surface, but
%% $\epsilon^{zz}_{\ell}(\omega)$ differs slightly. Broadening of
%% $\sigma=0.05\,\text{eV}$ applied on all curves.\label{fig:epsilon}}
%% \end{figure}
...
from Ref. \onlinecite{hoferAPA96} that the peaks in the spectrum redshift as
...
data presented in Ref. \onlinecite{hoferAPA96}. Theoretical curves are broadened
...
\onlinecite{mejiaPRB02}.\label{fig:RpS}}
\end{figure}
...
$\sigma=0.05\,\text{eV}$, and then $\mathcal{R}_{pS}$ is broadened with
$\sigma=0.10\,\text{eV}$. Experimental data taken from Ref.
\onlinecite{mitchellSS01}.\label{fig:mitchellRpS}}
\end{figure}
...
This is consistent with the results reported in Ref. \onlinecite{andersonPRB15},
...
$\sigma=0.10\,\text{eV}$. Experimental data taken from Ref.
\onlinecite{mejiaPRB02}.\label{fig:RsP}}
\end{figure}
...
$\sigma=0.10\,\text{eV}$. Experimental data taken from Ref.
\onlinecite{mejiaPRB02}.\label{fig:RpP}}
\end{figure}

Lastly, in Fig. \ref{fig:mitchellRpP} we compare to Ref.
\onlinecite{mitchellSS01}. The three layer model is, as before, very close in
...
$\sigma=0.05\,\text{eV}$, and then $\mathcal{R}_{pP}$ is broadened with
$\sigma=0.10\,\text{eV}$. Experimental data taken from Ref.
\onlinecite{mitchellSS01}.\label{fig:mitchellRpP}}
\end{figure}
