...
set yrange [-16:3]
set xrange [0:20]
p '../data/w-fix/down-odd-w-2.60343-p-5.d' u ($1+($1-1)):(per*DR($3,$6,$7,$4,$5,$8,$9)) w lp lt 1  pt 1 ps .5 t '5\%',\
  '../data/w-fix/down-odd-w-2.60343-p-10.d' u ($1+($1-1)):(per*DR($3,$6,$7,$4,$5,$8,$9)) w lp lt 1  pt 1 ps .5 t '10\%',\
  '../data/w-fix/down-odd-w-2.60343-p-15.d' u ($1+($1-1)):(per*DR($3,$6,$7,$4,$5,$8,$9)) w lp lt 1  pt 1 ps .5 t '15\%',\
  '../data/w-fix/down-odd-w-2.60343-p-20.d' u ($1+($1-1)):(per*DR($3,$6,$7,$4,$5,$8,$9)) w lp lt 1  pt 1 ps .5 t '20\%',\
  '../data/w-fix/down-odd-w-2.60343-p-25.d' u ($1+($1-1)):(per*DR($3,$6,$7,$4,$5,$8,$9)) w lp lt 1  pt 1 ps .5 t '25\%',\
  '../data/w-fix/down-odd-w-2.60343-p-30.d' u ($1+($1-1)):(per*DR($3,$6,$7,$4,$5,$8,$9)) w lp lt 1  pt 1 ps .5 t '30\%'
...
set label 2 '$\uparrow$ 30\%' at graph .5,.07
set label 3 '$\downarrow$ 5\%' at graph .5,.93
set label 4 '\large up' at graph .05,.2
#set yrange [-8:2]
set xrange [0:20]
