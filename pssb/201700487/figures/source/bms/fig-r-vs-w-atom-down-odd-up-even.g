...
set label 5 '\large up' at graph .05,.2
#set yrange [-8:2]
set xrange [0:20]
set xtics ('Si$_2$' 2,'Si$_4$' 4,'Si$_6$' 6,'Si$_8$' 8,'Si$_{10}$' 10,'Si$_{12}$' 12,'Si$_{14}$' 14,'Si$_{16}$' 16,'Si$_{18}$' 18)
p '../data/w-fix/up-even-w-1.79123-p-30.d' u (2*$1):(per*DR($3,$6,$7,$4,$5,$8,$9)) w lp lt 1  pt 1 ps .5 t '$\hbar\omega=1.8$\,eV',\
  '../data/w-fix/up-even-w-2.20783-p-30.d' u (2*$1):(per*DR($3,$6,$7,$4,$5,$8,$9)) w lp lt 1  pt 1 ps .5 t '$\hbar\omega=2.2$\,eV',\
  '../data/w-fix/up-even-w-2.39483-p-30.d' u (2*$1):(per*DR($3,$6,$7,$4,$5,$8,$9)) w lp lt 1  pt 1 ps .5 t '$\hbar\omega=2.4$\,eV',\
  '../data/w-fix/up-even-w-2.60343-p-30.d' u (2*$1):(per*DR($3,$6,$7,$4,$5,$8,$9)) w lp lt 1  pt 1 ps .5 t '$\hbar\omega=2.6$\,eV'
