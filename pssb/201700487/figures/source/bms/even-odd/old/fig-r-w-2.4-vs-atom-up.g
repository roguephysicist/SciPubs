...
per=100
set origin 0,3
set label 1 'up @ $\hbar\omega$=2.4\,eV' at graph .05,.9 
...
unset key
p  '../data/w-fix/up-odd-w-2.39483-p-6.d' u 1:(per*DR($4,$5,$6,$7)) w lp pt 1 ps .5 t '6\%',\
...
p  '../data/w-fix/up-even-w-2.39483-p-1.d' u 1:(per*DR($4,$5,$6,$7)) w lp lt 1  pt 1 ps .5 t '1\%',\
  '../data/w-fix/up-even-w-2.39483-p-2.d' u 1:(per*DR($4,$5,$6,$7)) w lp lt 1  pt 1 ps .5 t '2\%',\
  '../data/w-fix/up-even-w-2.39483-p-3.d' u 1:(per*DR($4,$5,$6,$7)) w lp lt 1  pt 1 ps .5 t '3\%',\
  '../data/w-fix/up-even-w-2.39483-p-4.d' u 1:(per*DR($4,$5,$6,$7)) w lp lt 1  pt 1 ps .5 t '4\%',\
  '../data/w-fix/up-even-w-2.39483-p-5.d' u 1:(per*DR($4,$5,$6,$7)) w lp lt 1  pt 1 ps .5 t '5\%',\
  '../data/w-fix/up-even-w-2.39483-p-6.d' u 1:(per*DR($4,$5,$6,$7)) w lp lt 1  pt 1 ps .5 t '6\%',\
  '../data/w-fix/up-even-w-2.39483-p-7.d' u 1:(per*DR($4,$5,$6,$7)) w lp lt 1  pt 1 ps .5 t '7\%',\
  '../data/w-fix/up-even-w-2.39483-p-8.d' u 1:(per*DR($4,$5,$6,$7)) w lp lt 1  pt 1 ps .5 t '8\%',\
  '../data/w-fix/up-even-w-2.39483-p-9.d' u 1:(per*DR($4,$5,$6,$7)) w lp lt 1  pt 1 ps .5 t '9\%',\
  '../data/w-fix/up-even-w-2.39483-p-10.d' u 1:(per*DR($4,$5,$6,$7)) w lp lt 1  pt 1 ps .5 t '10\%'
