...
set label 3 '$\hbar\omega$=2.4\,eV' at graph .5,.57 c
...
set yrange [-16:4]
set xrange [0:20]
p 'data/w-fix/down-odd-w-1.79123-p-30.d' u ($1+($1-1)):(per*DR($3,$6,$7,$4,$5,$8,$9)) w lp lt 1  pt 1 ps .5 t '$\hbar\omega=1.8$\,eV',\
  'data/w-fix/down-odd-w-2.20783-p-30.d' u ($1+($1-1)):(per*DR($3,$6,$7,$4,$5,$8,$9)) w lp lt 1  pt 1 ps .5 t '$\hbar\omega=2.2$\,eV',\
  'data/w-fix/down-odd-w-2.39483-p-30.d' u ($1+($1-1)):(per*DR($3,$6,$7,$4,$5,$8,$9)) w lp lt 1  pt 1 ps .5 t '$\hbar\omega=2.4$\,eV',\
  'data/w-fix/down-odd-w-2.60343-p-30.d' u ($1+($1-1)):(per*DR($3,$6,$7,$4,$5,$8,$9)) w lp lt 1  pt 1 ps .5 t '$\hbar\omega=2.6$\,eV'
